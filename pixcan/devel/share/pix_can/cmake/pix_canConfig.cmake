...
if(NOT "/home/nvidia/pixcan/devel/include;/home/nvidia/pixcan/src/pix_can/include " STREQUAL " ")
  set(pix_can_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/pixcan/devel/include;/home/nvidia/pixcan/src/pix_can/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pix_can' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/pixcan/src/pix_can/${idir}'.  ${_report}")
    endif()
